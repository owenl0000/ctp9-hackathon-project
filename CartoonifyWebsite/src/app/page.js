    ...
    <>
      ...
      <main className="bg-off-white">
        <div className="relative h-[500px]">
          <Slideshow />
          <section className="absolute top-0 left-0 right-0 h-[500px] flex flex-col justify-center items-center text-center p-5">
        ...
        <section className="bg-off-white p-12 h-[700px] flex items-center">
          <div className="bg-blue-900 py-12 mx-auto w-full h-full">
            ...
            <p className="font-pop-thin text-off-whitep text-justify text-[23px] mx-[350px] mb-[50px] leading-loose">
